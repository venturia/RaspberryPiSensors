<?php
$suffix="temperature";
$logfiletemplates=["/home/pi/log_bmp085_%04d-%02d-%02d.out","/home/pi/log_sht15_%04d-%02d-%02d.out","/home/pi/log_termometro_%04d-%02d-%02d.out","/home/pi/log_DS18b20_%04d-%02d-%02d.out"];
$dateindex=array();
...
$addresses=["BMP085_temp","SHT15_temp","0x4d","28-00000596c262","28-00000596d046"];
$labels=["Casa (C)","Test (C)","Test DS1621 (C)","Test Piano camere (C)","Sottoscala (C)"];
$tempindex=array();
